...
--2. 실수형 타입
--  - number(6, 2)는 소수점을 포함한 총자리수가 6자리이고 소수점 둘째  자리까지 있는 실수형 
--    값이 설정됩니다
--  - 첫번째 인자값 6은 소수점 자리수를 포함한 총자리수를 의미하고, 두번째 인자값 2는 소수점 
--     자리수를 의미합니다
...
--  - sysdate 와 systimestamp  는 현재일자와 시간을 반환하는 오라클 내부 키워드입니다
